...
var DashboardDetailComponent = (function () {
    function DashboardDetailComponent(heroService, route, location) {
    ...
    DashboardDetailComponent.prototype.goBack = function () {
        this.location.back();
    };
    DashboardDetailComponent.prototype.save = function (tower, isValid) {
        var _this = this;
        if (isValid)
